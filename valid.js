...
function togglePasswordVisibility(inputId, toggleId) {
    ...
    if (passwordInput.type === 'password') {
        ...
        togglePasswordButton.src = 'images/icon/show.png'; // Đổi hình ảnh mắt hiển thị
    } else {
        passwordInput.type = 'password';
        togglePasswordButton.src = 'images/icon/hide.png'; // Đổi hình ảnh mắt ẩn
    }
}
...
function signUp(event) {
    ...
    xhr.open("GET", "user_data.xml", false);
    xhr.send();
